...
const WORDS = [
  ...
  {id:"w76",sub:"な-Sıfat",char:"大丈夫",tr:"sorun yok / tamam",read:"だいじょうぶ",ex:"だいじょうぶですか？ — Sorun yok mu?"},
...
// ══════════════════════════════════════════════════════════
// DATA — JOSUSHI (Counter Words / 助数詞)
// ══════════════════════════════════════════════════════════
// Each counter: { id, counter, kanji, meaning, items, readings }
// readings: array of { n, read } for n=1..10 + special
const JOSUSHI = [
  { id:"jc1", counter:"つ", kanji:"—", meaning:"Genel sayma (wago)", items:"Soyut şeyler, nesnel sayım",
    readings:[
      {n:"1",jp:"一つ",read:"ひとつ"},{n:"2",jp:"二つ",read:"ふたつ"},{n:"3",jp:"三つ",read:"みっつ"},
      {n:"4",jp:"四つ",read:"よっつ"},{n:"5",jp:"五つ",read:"いつつ"},{n:"6",jp:"六つ",read:"むっつ"},
      {n:"7",jp:"七つ",read:"ななつ"},{n:"8",jp:"八つ",read:"やっつ"},{n:"9",jp:"九つ",read:"ここのつ"},
      {n:"10",jp:"十",read:"とお"},{n:"?",jp:"いくつ",read:"いくつ"},
    ]
  },
  { id:"jc2", counter:"個", kanji:"個", meaning:"Küçük nesneler", items:"Elma, yumurta, taş, top...",
    readings:[
      {n:"1",jp:"一個",read:"いっこ"},{n:"2",jp:"二個",read:"にこ"},{n:"3",jp:"三個",read:"さんこ"},
      {n:"4",jp:"四個",read:"よんこ"},{n:"5",jp:"五個",read:"ごこ"},{n:"6",jp:"六個",read:"ろっこ"},
      {n:"7",jp:"七個",read:"ななこ"},{n:"8",jp:"八個",read:"はちこ"},{n:"9",jp:"九個",read:"きゅうこ"},
      {n:"10",jp:"十個",read:"じゅっこ"},{n:"?",jp:"何個",read:"なんこ"},
    ]
  },
  { id:"jc3", counter:"人", kanji:"人", meaning:"İnsanlar", items:"Kişiler",
    readings:[
      {n:"1",jp:"一人",read:"ひとり"},{n:"2",jp:"二人",read:"ふたり"},{n:"3",jp:"三人",read:"さんにん"},
      {n:"4",jp:"四人",read:"よにん"},{n:"5",jp:"五人",read:"ごにん"},{n:"6",jp:"六人",read:"ろくにん"},
      {n:"7",jp:"七人",read:"しちにん"},{n:"8",jp:"八人",read:"はちにん"},{n:"9",jp:"九人",read:"きゅうにん"},
      {n:"10",jp:"十人",read:"じゅうにん"},{n:"?",jp:"何人",read:"なんにん"},
    ]
  },
  { id:"jc4", counter:"匹", kanji:"匹", meaning:"Küçük/orta hayvanlar", items:"Kedi, köpek, balık, böcek...",
    readings:[
      {n:"1",jp:"一匹",read:"いっぴき"},{n:"2",jp:"二匹",read:"にひき"},{n:"3",jp:"三匹",read:"さんびき"},
      {n:"4",jp:"四匹",read:"よんひき"},{n:"5",jp:"五匹",read:"ごひき"},{n:"6",jp:"六匹",read:"ろっぴき"},
      {n:"7",jp:"七匹",read:"ななひき"},{n:"8",jp:"八匹",read:"はちひき"},{n:"9",jp:"九匹",read:"きゅうひき"},
      {n:"10",jp:"十匹",read:"じゅっぴき"},{n:"?",jp:"何匹",read:"なんびき"},
    ]
  },
  { id:"jc5", counter:"頭", kanji:"頭", meaning:"Büyük hayvanlar", items:"İnek, at, fil, balina...",
    readings:[
      {n:"1",jp:"一頭",read:"いっとう"},{n:"2",jp:"二頭",read:"にとう"},{n:"3",jp:"三頭",read:"さんとう"},
      {n:"4",jp:"四頭",read:"よんとう"},{n:"5",jp:"五頭",read:"ごとう"},{n:"6",jp:"六頭",read:"ろくとう"},
      {n:"7",jp:"七頭",read:"ななとう"},{n:"8",jp:"八頭",read:"はちとう"},{n:"9",jp:"九頭",read:"きゅうとう"},
      {n:"10",jp:"十頭",read:"じゅっとう"},{n:"?",jp:"何頭",read:"なんとう"},
    ]
  },
  { id:"jc6", counter:"本", kanji:"本", meaning:"Uzun silindirik nesneler", items:"Kalem, şişe, ağaç, nehir, film...",
    readings:[
      {n:"1",jp:"一本",read:"いっぽん"},{n:"2",jp:"二本",read:"にほん"},{n:"3",jp:"三本",read:"さんぼん"},
      {n:"4",jp:"四本",read:"よんほん"},{n:"5",jp:"五本",read:"ごほん"},{n:"6",jp:"六本",read:"ろっぽん"},
      {n:"7",jp:"七本",read:"ななほん"},{n:"8",jp:"八本",read:"はちほん"},{n:"9",jp:"九本",read:"きゅうほん"},
      {n:"10",jp:"十本",read:"じゅっぽん"},{n:"?",jp:"何本",read:"なんぼん"},
    ]
  },
  { id:"jc7", counter:"枚", kanji:"枚", meaning:"Yassı/ince nesneler", items:"Kağıt, tabak, pul, gömlek, CD...",
    readings:[
      {n:"1",jp:"一枚",read:"いちまい"},{n:"2",jp:"二枚",read:"にまい"},{n:"3",jp:"三枚",read:"さんまい"},
      {n:"4",jp:"四枚",read:"よんまい"},{n:"5",jp:"五枚",read:"ごまい"},{n:"6",jp:"六枚",read:"ろくまい"},
      {n:"7",jp:"七枚",read:"ななまい"},{n:"8",jp:"八枚",read:"はちまい"},{n:"9",jp:"九枚",read:"きゅうまい"},
      {n:"10",jp:"十枚",read:"じゅうまい"},{n:"?",jp:"何枚",read:"なんまい"},
    ]
  },
  { id:"jc8", counter:"台", kanji:"台", meaning:"Makine/araçlar", items:"Araba, bisiklet, bilgisayar, TV...",
    readings:[
      {n:"1",jp:"一台",read:"いちだい"},{n:"2",jp:"二台",read:"にだい"},{n:"3",jp:"三台",read:"さんだい"},
      {n:"4",jp:"四台",read:"よんだい"},{n:"5",jp:"五台",read:"ごだい"},{n:"6",jp:"六台",read:"ろくだい"},
      {n:"7",jp:"七台",read:"ななだい"},{n:"8",jp:"八台",read:"はちだい"},{n:"9",jp:"九台",read:"きゅうだい"},
      {n:"10",jp:"十台",read:"じゅうだい"},{n:"?",jp:"何台",read:"なんだい"},
    ]
  },
  { id:"jc9", counter:"冊", kanji:"冊", meaning:"Ciltli yayınlar", items:"Kitap, defter, dergi, manga...",
    readings:[
      {n:"1",jp:"一冊",read:"いっさつ"},{n:"2",jp:"二冊",read:"にさつ"},{n:"3",jp:"三冊",read:"さんさつ"},
      {n:"4",jp:"四冊",read:"よんさつ"},{n:"5",jp:"五冊",read:"ごさつ"},{n:"6",jp:"六冊",read:"ろくさつ"},
      {n:"7",jp:"七冊",read:"ななさつ"},{n:"8",jp:"八冊",read:"はちさつ"},{n:"9",jp:"九冊",read:"きゅうさつ"},
      {n:"10",jp:"十冊",read:"じゅっさつ"},{n:"?",jp:"何冊",read:"なんさつ"},
    ]
  },
  { id:"jc10", counter:"杯", kanji:"杯", meaning:"Bardak/kase içecek/yemek", items:"Su, çay, kahve, çorba, pirinç...",
    readings:[
      {n:"1",jp:"一杯",read:"いっぱい"},{n:"2",jp:"二杯",read:"にはい"},{n:"3",jp:"三杯",read:"さんばい"},
      {n:"4",jp:"四杯",read:"よんはい"},{n:"5",jp:"五杯",read:"ごはい"},{n:"6",jp:"六杯",read:"ろっぱい"},
      {n:"7",jp:"七杯",read:"ななはい"},{n:"8",jp:"八杯",read:"はちはい"},{n:"9",jp:"九杯",read:"きゅうはい"},
      {n:"10",jp:"十杯",read:"じゅっぱい"},{n:"?",jp:"何杯",read:"なんばい"},
    ]
  },
  { id:"jc11", counter:"回", kanji:"回", meaning:"Kez / defa", items:"Tekrar sayısı, tur sayısı...",
    readings:[
      {n:"1",jp:"一回",read:"いっかい"},{n:"2",jp:"二回",read:"にかい"},{n:"3",jp:"三回",read:"さんかい"},
      {n:"4",jp:"四回",read:"よんかい"},{n:"5",jp:"五回",read:"ごかい"},{n:"6",jp:"六回",read:"ろっかい"},
      {n:"7",jp:"七回",read:"ななかい"},{n:"8",jp:"八回",read:"はちかい"},{n:"9",jp:"九回",read:"きゅうかい"},
      {n:"10",jp:"十回",read:"じゅっかい"},{n:"?",jp:"何回",read:"なんかい"},
    ]
  },
  { id:"jc12", counter:"階", kanji:"階", meaning:"Kat (bina)", items:"Binanın katları",
    readings:[
      {n:"1",jp:"一階",read:"いっかい"},{n:"2",jp:"二階",read:"にかい"},{n:"3",jp:"三階",read:"さんがい"},
      {n:"4",jp:"四階",read:"よんかい"},{n:"5",jp:"五階",read:"ごかい"},{n:"6",jp:"六階",read:"ろっかい"},
      {n:"7",jp:"七階",read:"ななかい"},{n:"8",jp:"八階",read:"はちかい"},{n:"9",jp:"九階",read:"きゅうかい"},
      {n:"10",jp:"十階",read:"じゅっかい"},{n:"?",jp:"何階",read:"なんがい"},
    ]
  },
  { id:"jc13", counter:"分", kanji:"分", meaning:"Dakika", items:"Süre (dakika)",
    readings:[
      {n:"1",jp:"一分",read:"いっぷん"},{n:"2",jp:"二分",read:"にふん"},{n:"3",jp:"三分",read:"さんぷん"},
      {n:"4",jp:"四分",read:"よんぷん"},{n:"5",jp:"五分",read:"ごふん"},{n:"6",jp:"六分",read:"ろっぷん"},
      {n:"7",jp:"七分",read:"ななふん"},{n:"8",jp:"八分",read:"はっぷん"},{n:"9",jp:"九分",read:"きゅうふん"},
      {n:"10",jp:"十分",read:"じゅっぷん"},{n:"?",jp:"何分",read:"なんぷん"},
    ]
  },
  { id:"jc14", counter:"日", kanji:"日", meaning:"Gün (süre / tarih)", items:"Kaç gün / hangi günü",
    readings:[
      {n:"1",jp:"一日",read:"いちにち／ついたち"},{n:"2",jp:"二日",read:"ふつか"},{n:"3",jp:"三日",read:"みっか"},
      {n:"4",jp:"四日",read:"よっか"},{n:"5",jp:"五日",read:"いつか"},{n:"6",jp:"六日",read:"むいか"},
      {n:"7",jp:"七日",read:"なのか"},{n:"8",jp:"八日",read:"ようか"},{n:"9",jp:"九日",read:"ここのか"},
      {n:"10",jp:"十日",read:"とおか"},{n:"20",jp:"二十日",read:"はつか"},{n:"?",jp:"何日",read:"なんにち"},
    ]
  },
  { id:"jc15", counter:"箇月", kanji:"箇月", meaning:"Ay (süre)", items:"Kaç ay sürdü / geçti",
    readings:[
      {n:"1",jp:"一箇月",read:"いっかげつ"},{n:"2",jp:"二箇月",read:"にかげつ"},{n:"3",jp:"三箇月",read:"さんかげつ"},
      {n:"4",jp:"四箇月",read:"よんかげつ"},{n:"5",jp:"五箇月",read:"ごかげつ"},{n:"6",jp:"六箇月",read:"ろっかげつ"},
      {n:"7",jp:"七箇月",read:"ななかげつ"},{n:"8",jp:"八箇月",read:"はちかげつ"},{n:"9",jp:"九箇月",read:"きゅうかげつ"},
      {n:"10",jp:"十箇月",read:"じゅっかげつ"},{n:"?",jp:"何箇月",read:"なんかげつ"},
    ]
  },
];

// Build flat question list from JOSUSHI
function buildJosushiQuestions() {
  const qs = [];
  for (const jc of JOSUSHI) {
    for (const r of jc.readings) {
      qs.push({
        id: `${jc.id}_${r.n}`,
        kind: "josushi",
        counter: jc.counter,
        ...
        jp: r.jp,
        read: r.read,
        // question: show jp, ask reading
        char: r.jp,
        tr: `${r.n} ${jc.meaning.split(" ")[0].toLowerCase()} (${jc.counter})`,
        answer: r.read,
        isJpAnswer: true, isKun: false,
        mnemoType: "vocab",
        typeColor: "#e67e22",
        typeLabel: "助数詞",
        subLabel: `${jc.counter} — ${jc.meaning}`,
        promptLabel: "Okuyuş",
        promptLine: "Hiragana ile yaz:",
        showFurigana: false,
        extraRows: [{label:"Sayaç", val:`${jc.counter} (${jc.meaning})`, jp:false},{label:"Kullanım", val:jc.items, jp:false}],
      });
    }
  }
  return qs;
...
const JOSUSHI_QUESTIONS = buildJosushiQuestions();
...
const GRAMMAR_FILL = [
  ...
  // ── PDF ワークシート Level 1 ──
  {id:"pf29",lesson:5,sentence:"明日、友だち___海___行きます。",blank:"と・へ",hint:"と = birlikte, へ = yön",choices:["と・へ","で・に","に・を","が・で"],category:"particle"},
  {id:"pf30",lesson:5,sentence:"先週、どこ___行きましたか。",blank:"へ",hint:"へ = gidilen yer",choices:["へ","に","で","を"],category:"particle"},
  {id:"pf31",lesson:5,sentence:"なん___アメリカへ行きましたか。",blank:"で",hint:"で = ulaşım aracı",choices:["で","に","を","と"],category:"particle"},
  {id:"pf32",lesson:4,sentence:"いつ国___帰りますか。",blank:"へ",hint:"へ = dönülen yer",choices:["へ","に","で","を"],category:"particle"},
  {id:"pf33",lesson:4,sentence:"12月___帰ります。",blank:"に",hint:"に = zaman noktası",choices:["に","で","へ","を"],category:"particle"},
  {id:"pf34",lesson:5,sentence:"だれ___学校へ来ましたか。",blank:"が",hint:"が = özne partiküli",choices:["が","は","を","に"],category:"particle"},
  {id:"pf35",lesson:6,sentence:"なに___日本語を勉強しましたか。",blank:"で",hint:"で = araç/yöntem",choices:["で","に","を","と"],category:"particle"},
  {id:"pf36",lesson:4,sentence:"日曜日___動物園___行きました。",blank:"に・へ",hint:"に = zaman, へ = yön",choices:["に・へ","で・を","が・に","は・で"],category:"particle"},
  {id:"pf37",lesson:5,sentence:"電車___家___帰りました。",blank:"で・へ",hint:"で = araç, へ = hedef",choices:["で・へ","に・を","が・で","は・に"],category:"particle"},
  {id:"pf38",lesson:5,sentence:"一人___歩いて行きました。",blank:"で",hint:"で = yöntem/durum",choices:["で","に","を","と"],category:"particle"},
  {id:"pf39",lesson:3,sentence:"今日は６月___５日です。",blank:"の",hint:"の = bağlantı (ay/gün)",choices:["の","に","で","を"],category:"particle"},
  {id:"pf40",lesson:6,sentence:"先週___デパート___買い物しました。",blank:"は・で",hint:"は = konu, で = eylem yeri",choices:["は・で","が・に","を・へ","も・で"],category:"particle"},
  {id:"pf41",lesson:5,sentence:"バス___駅___行きました。",blank:"で・へ",hint:"で = araç, へ = hedef",choices:["で・へ","に・を","が・で","は・に"],category:"particle"},
  {id:"pf42",lesson:5,sentence:"友だち___家___来ました。",blank:"が・へ",hint:"が = özne, へ = hedef",choices:["が・へ","は・に","を・で","も・へ"],category:"particle"},
  {id:"pf43",lesson:5,sentence:"来週、友だち___東京___行きます。",blank:"と・へ",hint:"と = birlikte, へ = yön",choices:["と・へ","で・に","に・を","が・で"],category:"particle"},
  {id:"pf44",lesson:5,sentence:"だれ___一緒に勉強しましたか。",blank:"と",hint:"と = ile/birlikte",choices:["と","に","で","が"],category:"particle"},
  {id:"pf45",lesson:4,sentence:"2022年5月___来ました。",blank:"に",hint:"に = zaman noktası (yıl/ay)",choices:["に","で","へ","を"],category:"particle"},
  {id:"pf46",lesson:5,sentence:"バイク___行きます。",blank:"で",hint:"で = ulaşım aracı",choices:["で","に","へ","を"],category:"particle"},
  {id:"pf47",lesson:4,sentence:"きのう___学校へ行きませんでした。",blank:"は",hint:"は = konu partiküli (kontrast)",choices:["は","が","も","を"],category:"particle"},
  {id:"pf48",lesson:5,sentence:"来年、友だちと旅行___行きます。",blank:"へ",hint:"へ = gidilen yer",choices:["へ","に","で","を"],category:"particle"},
  {id:"pf49",lesson:6,sentence:"駅___タクシー___行きました。",blank:"へ・で",hint:"へ = hedef, で = araç",choices:["へ・で","に・が","を・に","で・へ"],category:"particle"},
  {id:"pf50",lesson:4,sentence:"週末___家___ゆっくりしました。",blank:"は・で",hint:"は = konu, で = eylem yeri",choices:["は・で","が・に","を・へ","も・で"],category:"particle"},
  {id:"pf51",lesson:3,sentence:"明日の朝、新幹線___京都___行きます。",blank:"で・へ",hint:"で = araç, へ = hedef",choices:["で・へ","に・を","が・で","は・に"],category:"particle"},
  {id:"pf52",lesson:6,sentence:"きのう、デパート___買い物___しました。",blank:"で・を",hint:"で = eylem yeri, を = nesne",choices:["で・を","に・が","へ・に","は・で"],category:"particle"},
  {id:"pf53",lesson:3,sentence:"日本語のクラスは週___３日あります。",blank:"に",hint:"に = birim (haftada 3 gün)",choices:["に","で","の","を"],category:"particle"},
  {id:"pf54",lesson:5,sentence:"友だちと公園___ピクニックをしました。",blank:"で",hint:"で = eylemin gerçekleştiği yer",choices:["で","に","へ","を"],category:"particle"},
  {id:"pf55",lesson:5,sentence:"学校___歩いて行きます。",blank:"へ",hint:"へ = yön/hedef",choices:["へ","に","で","を"],category:"particle"},
  {id:"pf56",lesson:4,sentence:"６月___京都___桜___見ました。",blank:"に・で・を",hint:"に=zaman, で=yer, を=nesne",choices:["に・で・を","で・に・を","を・で・に","に・を・で"],category:"particle"},
  {id:"pf57",lesson:6,sentence:"朝ごはん___パン___食べました。",blank:"は・を",hint:"は = konu, を = nesne",choices:["は・を","が・を","に・で","を・は"],category:"particle"},
  {id:"pf58",lesson:4,sentence:"日曜日___海___泳ぎに行きます。",blank:"に・へ",hint:"に = zaman, へ = yön",choices:["に・へ","で・を","が・に","は・で"],category:"particle"},
  {id:"pf59",lesson:5,sentence:"電車___学校___１時間かかります。",blank:"で・まで",hint:"で = araç, まで = bitiş noktası",choices:["で・まで","に・を","が・で","は・に"],category:"particle"},
  {id:"pf60",lesson:3,sentence:"来週___月曜日___テスト___あります。",blank:"の・に・が",hint:"の=bağlantı, に=zaman, が=özne",choices:["の・に・が","を・で・は","が・に・を","は・で・が"],category:"particle"},
  {id:"pf61",lesson:3,sentence:"これ___だれ___かばんですか。",blank:"は・の",hint:"は = konu, の = sahiplik",choices:["は・の","が・の","を・の","に・の"],category:"particle"},
  {id:"pf62",lesson:4,sentence:"毎朝６時___起きます。そして７時___朝ごはん___食べます。",blank:"に・に・を",hint:"に=zaman, に=zaman, を=nesne",choices:["に・に・を","で・で・を","が・に・を","に・を・に"],category:"particle"},
  {id:"pf63",lesson:4,sentence:"試験___何時___始まりますか。",blank:"は・に",hint:"は = konu, に = zaman",choices:["は・に","が・で","を・に","に・は"],category:"particle"},
  {id:"pf64",lesson:5,sentence:"日本___トルコ___飛行機___帰ります。",blank:"から・へ・で",hint:"から=başlangıç, へ=hedef, で=araç",choices:["から・へ・で","に・を・で","で・へ・に","から・に・で"],category:"particle"},
  {id:"pf65",lesson:6,sentence:"茶道のお茶会は日本___お寺___します。",blank:"の・で",hint:"の = bağlantı, で = eylem yeri",choices:["の・で","を・に","が・へ","に・で"],category:"particle"},
];
...
// Convert grammar questions to QuizPage-compatible format
function makeGrammarQ(g, gType) {
  const ACCENT = "#16a085";
  const typeLabels = {
    scramble:"🔀 Scramble", fill:"✏️ Boşluk", particle:"🔗 Partikül",
    pattern:"🏗 Yapı", qa:"💬 Soru-Cevap", translation:"🔤 Çeviri",
  };
  const label = typeLabels[gType] || "文法";

  if (gType==="fill" || gType==="particle") {
    // Multiple-choice fill — rendered as free-text in QuizPage (choices shown as hint)
    return {
      uid: g.id+"_gfill",
      id: g.id, kind:"grammar_fill",
      typeColor: ACCENT, typeLabel:"文法", subLabel: gType==="particle"?"Partikül":"Boşluk Doldur",
      char: g.sentence.replace("___","＿＿＿"),
      tr: g.hint, read:"", ex: null,
      showFurigana: false,
      promptLabel: "Eksik parça",
      promptLine: `Seçenekler: ${g.choices.join(" / ")}`,
      answer: g.blank,
      isJpAnswer: true, isKun: false,
      mnemoType: "vocab",
      extraRows: [{label:"İpucu", val:g.hint, jp:false}],
      choices: g.choices,
    };
  }
  if (gType==="scramble") {
    return {
      uid: g.id+"_gscr",
      id: g.id, kind:"grammar_text",
      typeColor: ACCENT, typeLabel:"文法", subLabel:"Scramble",
      char: g.hint,
      tr: g.hint, read:"", ex:null,
      showFurigana: false,
      promptLabel: "Parçaları birleştir",
      promptLine: `Kelimeler: ${g.parts.join(" ・ ")}`,
      answer: g.answer,
      isJpAnswer: true, isKun: false,
      mnemoType:"vocab",
      extraRows: [{label:"Parçalar", val:g.parts.join(" ・ "), jp:true}],
    };
  }
  if (gType==="pattern") {
    return {
      uid: g.id+"_gpat",
      id: g.id, kind:"grammar_text",
      typeColor: ACCENT, typeLabel:"文法", subLabel:"Yapı Drill",
      char: g.pattern,
      tr: g.hint, read:"", ex:null,
      showFurigana: false,
      promptLabel: "Cümleyi kur",
      promptLine: `İpucu: ${g.cue}`,
      answer: g.answer,
      isJpAnswer: true, isKun: false,
      mnemoType:"vocab",
      extraRows: [{label:"İpucu", val:g.cue, jp:true},{label:"Türkçe", val:g.hint, jp:false}],
    };
  }
  if (gType==="translation") {
    return {
      uid: g.id+"_gtr",
      id: g.id, kind:"grammar_text",
      typeColor: ACCENT, typeLabel:"文法", subLabel:"Çeviri",
      char: g.turkish,
      tr: g.turkish, read:"", ex:null,
      showFurigana: false,
      promptLabel: "Japonca çeviri",
      promptLine: `İpucu: ${g.hint}`,
      answer: g.answer,
      isJpAnswer: true, isKun: false,
      mnemoType:"vocab",
      extraRows: [{label:"İpucu", val:g.hint, jp:false}],
  ...
  return {
    uid: g.id+"_gqa",
    id: g.id, kind:"grammar_text",
    typeColor: ACCENT, typeLabel:"文法", subLabel:"Soru-Cevap",
    char: g.question,
    tr: g.hint, read:"", ex:null,
    showFurigana: false,
    promptLabel: "Japonca cevap",
    promptLine: g.hint,
    answer: g.answer,
    isJpAnswer: true, isKun: false,
    mnemoType:"vocab",
    extraRows: [{label:"Örnek", val:g.example||"", jp:true}],
  };
}
...
function buildBatch(cfg) {
  ...
  if (cfg.mode==="josushi") {
    const filter = cfg.josushiFilter || "all";
    const pool = filter==="all" ? JOSUSHI_QUESTIONS : JOSUSHI_QUESTIONS.filter(q=>q.counter===filter);
    shuffle(pool).slice(0, 20).forEach(q => qs.push({...q, uid: q.id+"_q"}));
    return shuffle(qs);
  }

  if (cfg.mode==="ultimate") {
    // 4 vocab
    shuffle(WORDS).slice(0,4).forEach(w=>qs.push(makeWordQ(w,"mixed")));
    // 3 kanji + 2 kanji words
    shuffle(KANJI).slice(0,3).forEach(k=>qs.push(makeKanjiQ(k,"both")));
    shuffle(KANJI_WORDS).slice(0,2).forEach(w=>qs.push(makeKanjiWordQ(w)));
    // 2 numbers/times
    shuffle([...NUMBERS,...TIMES]).slice(0,2).forEach(item=>
      qs.push(makeNumberQ(item, TIMES.some(t=>t.id===item.id)?"time":"number")));
    // 2 josushi
    shuffle(JOSUSHI_QUESTIONS).slice(0,2).forEach(q=>qs.push({...q,uid:q.id+"_uq"}));
    // 3 grammar: pick from scramble, particle fill, translation evenly
    shuffle(GRAMMAR_SCRAMBLE).slice(0,1).forEach(g=>qs.push(makeGrammarQ(g,"scramble")));
    shuffle(GRAMMAR_FILL.filter(q=>q.category==="particle")).slice(0,1).forEach(g=>qs.push(makeGrammarQ(g,"particle")));
    shuffle(GRAMMAR_TRANS).slice(0,1).forEach(g=>qs.push(makeGrammarQ(g,"translation")));
    return shuffle(qs); // toplam ~20
  }
...
function SettingsPage({onStart,onBrowse,onGrammar}){
  ...
  const [josushiFilter,setJosushiFilter]=useState("all");
  const [skipPreview,setSkip]=useState(false);

  const modeColor=mode==="kanji"?C.kanji:mode==="vocab"?C.vocab:mode==="numbers"?"#8e44ad":mode==="josushi"?"#e67e22":mode==="ultimate"?"#c0392b":C.mixed;
    ...
    <div style={{maxWidth:560,width:"100%",margin:"0 auto",paddingTop:32}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:24}}>
        {[
          ...
          {val:"josushi",color:"#e67e22",icon:"助",  sub:"Sayaçlar", cnt:`${JOSUSHI_QUESTIONS.length} öğe`},
          {val:"ultimate",color:"#c0392b",icon:"全",  sub:"Hepsi Bir Arada", cnt:"kelime+kanji+sayı+sayaç+gramer"},
          {val:"grammar", color:"#16a085",icon:"文法",sub:"Gramer",   cnt:`${GRAMMAR_SCRAMBLE.length+GRAMMAR_FILL.length+GRAMMAR_PATTERN.length+GRAMMAR_QA.length+GRAMMAR_TRANS.length} soru`},
      ...
      {mode==="josushi"&&(
        <div style={{background:"#fff",border:`1px solid ${C.border}`,borderTop:"4px solid #e67e22",borderRadius:8,padding:"18px 18px 10px",marginBottom:14}}>
          <div style={{fontSize:11,fontWeight:700,color:"#e67e22",marginBottom:14,letterSpacing:1}}>助数詞 SAYAÇ SEÇİMİ</div>
          <Sec title="Sayaç türü">
            <Btn val="all" cur={josushiFilter} set={setJosushiFilter} color="#e67e22">Tümü ({JOSUSHI_QUESTIONS.length})</Btn>
            {JOSUSHI.map(jc=>{
              const cnt = JOSUSHI_QUESTIONS.filter(q=>q.counter===jc.counter).length;
              return <Btn key={jc.id} val={jc.counter} cur={josushiFilter} set={setJosushiFilter} color="#e67e22">{jc.counter} {jc.meaning.split(" ")[0]} ({cnt})</Btn>;
            })}
          </Sec>
        </div>
      )}
      ...
      <button onClick={()=>onStart({mode,wordType,wordDir,kanjiLesson:kanjiL,kanjiMode,skipPreview,numType,josushiFilter})} style={{
...
function QuizPage({queue:initialQueue, onDone, onBack}) {
  ...
  return(
    <div style={{width:"100%",maxWidth:640,margin:"0 auto"}}>
      ...
      {/* Grammar fill choices */}
      {q.kind==="grammar_fill" && !submitted && q.choices && (
        <div style={{display:"flex",gap:8,flexWrap:"wrap",padding:"12px 16px",background:"#f9f9f9",borderBottom:"1px solid #e8e8e8"}}>
          {q.choices.map(c=>(
            <button key={c} onClick={()=>{setAns(c);}} style={{
              padding:"8px 16px",borderRadius:6,cursor:"pointer",fontSize:15,
              border:`2px solid ${ans===c?"#16a085":C.border}`,
              background:ans===c?"#16a085":"#fff",
              color:ans===c?"#fff":C.text,
              fontFamily:"'Noto Serif JP',serif",fontWeight:ans===c?700:400,
              transition:"all .15s",
            }}>{c}</button>
          ))}
        </div>
